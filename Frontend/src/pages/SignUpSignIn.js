...
import ScrollDownArrow from '../components/ScrollDownArrow.jsx';
import ScrollToTopArrow from '../components/ScrollToTopArrow.jsx';
...
function SignUpSignIn() {
  ...
  return (
    <>
      ...
      <header className="hero relative pt-24 -mt-24 bg-gradient-to-br from-gray-900/50 via-navy-900/50 to-navy-950/50 min-h-screen flex items-center justify-center">
        ...
        <section className="relative py-16 lg:py-24 xl:py-32 px-6 sm:px-8 lg:px-16 bg-[#189172]">
          <div className="container mx-auto">
            <div className="grid gap-8 lg:gap-12 xl:gap-16 items-center lg:grid-cols-2">
              ...
              <li className="flex flex-col items-center bg-white rounded-lg shadow-lg p-6">
                <div className="bg-gradient-to-br from-[#189172] to-[#26292B] rounded-full aspect-square w-full max-w-64 flex items-center justify-center mb-5">
                  {/* <img src={feature1} alt="Feature 1 Graphics" className="h-40 w-40 mb-8" /> */}
                </div>
                <h3 className="font-heading text-xl mb-2 text-[#26292B]">
